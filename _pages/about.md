    ...
    <section class="about-block about-block--edu-exp">
      <div class="about-block-content">
        ...
        <div class="about-training-flow">
          ...
          <div class="about-flow-group">
            <h3 class="about-flow-sub">Experience</h3>
            <ul class="about-flow-list">
              <li>
                <span class="about-flow-main">Graduate Teaching Assistant — Global Society, Human Sexuality — <a href="https://www.fau.edu/artsandletters/sociology/">Florida Atlantic University</a></span>
                <span class="about-flow-year">2023–2025</span>
              </li>
              <li>
                <span class="about-flow-main">Co-president, Graduate Sociology Student Association — <a href="https://www.fau.edu/artsandletters/sociology/">Florida Atlantic University</a></span>
                <span class="about-flow-year">2023–2025</span>
              </li>
              <li>
