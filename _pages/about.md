...
<div class="media-lab-about-page">
  <header class="about-hero">
    <div class="hero-number">03</div>
    <div class="about-hero-content">
      {% if page.logo %}
      <div class="about-photo-large">
        <img src="{{ site.github.url }}/{{ page.logo }}" alt="Resat Amin">
      </div>
      {% endif %}
  ...
  <div class="about-content-modern">
    <section class="about-block">
      ...
      <div class="about-block-content">
        ...
        <p>
          ...
          and liberation shaped my commitment to social justice and equality.
        </p>
        <p>
    ...
    <section class="video-section">
      <h2 class="section-title">Video Materials</h2>
    ...
    <section class="about-tags-section">
      <h2 class="section-title">Areas of Inquiry</h2>
      <div class="collaboration-tags">
        <span class="collab-tag">Feminist Activism</span>
        <span class="collab-tag">Digital Platforms</span>
        <span class="collab-tag">Algorithmic Bias</span>
        <span class="collab-tag">Social Movements</span>
        <span class="collab-tag">State Power</span>
    ...
    <section class="about-contact-section">
      ...
      <p class="contact-main">
        <a href="mailto:resat.amin@gmail.com">resat.amin@gmail.com</a>
      </p>
      <p class="contact-secondary">
        <a href="https://twitter.com/AminResat" target="_blank" rel="noopener">Twitter</a> · 
        <a href="https://www.linkedin.com/in/resat-amin-priya-06a740202/" target="_blank" rel="noopener">LinkedIn</a>
      </p>
    </section>
  </div>
</div>